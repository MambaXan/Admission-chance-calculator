    ...
    <div className="admission-page">
      <div className="calculator-container">
        <div className="calculator-header">
          ...
          <p>Узнайте свои шансы в ведущих университетах мира</p>
        </div>

        <form onSubmit={handleSubmit} className="calculator-form">
          <div className="form-section">
            <h3>Ваши академические показатели</h3>
      ...
      {showResults && (
        <div className="results-container">
          <div className="results-header">
            <h2>Результаты</h2>
            <p>Найдено {results.length} университетов</p>
          </div>

          {noMatches ? (
            <div className="no-results">Университетов по выбранным критериям не найдено</div>
          ) : (
